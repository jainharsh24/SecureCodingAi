...
public class Challenge {
    ...
    protected Challenge() { }
    public Challenge(String title, String description, String language, String type, String subtype, String cwe, String starterCode) {
        update(title, description, language, type, subtype, cwe, starterCode);
    }
    public void update(String title, String description, String language, String type, String subtype, String cwe, String starterCode) {
        this.title = title; this.description = description; this.language = language; this.vulnerabilityType = type;
        this.vulnerabilitySubtype = subtype; this.cwe = cwe; this.starterCode = starterCode;
    }
